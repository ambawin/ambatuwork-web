...
<div class="max-w-6xl mx-auto px-6 py-8">
    ...
    <div class="space-y-8">
        ...
        <div class="bg-white/85 backdrop-blur-md p-8 rounded-3xl shadow-sm flex flex-col md:flex-row items-center gap-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="space-y-8">
                ...
                <div class="bg-white/85 backdrop-blur-md p-8 rounded-3xl shadow-sm">
                    <h3 class="text-lg font-black text-[#604B10] flex items-center gap-2 mb-6 pb-4">
                        <x-heroicon-s-presentation-chart-line class="w-5 h-5 text-[#876A1A]"/>
                        Activity Overview
                    </h3>
                    <div class="grid grid-cols-3 gap-4 text-center">
                        <div class="bg-[#FDCB40]/5 p-4 rounded-2xl">
                ...
                <div class="bg-white/85 backdrop-blur-md p-8 rounded-3xl shadow-sm">
                    <h3 class="text-lg font-black text-[#604B10] flex items-center gap-2 mb-6 pb-4">
                        <x-heroicon-s-clipboard-document-check class="w-5 h-5 text-[#876A1A]"/>
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            @php
                                $statuses = [
                                    'todo' => ['label' => 'To Do', 'color' => 'bg-[#876A1A]/30'],
                                    'in_progress' => ['label' => 'In Progress', 'color' => 'bg-[#876A1A]/70'],
                                    'test' => ['label' => 'Testing', 'color' => 'bg-[#604B10]/70'],
                                    'done' => ['label' => 'Done', 'color' => 'bg-[#FDCB40]'],
                                ];
                            @endphp
                            @foreach($statuses as $statusKey => $statusData)
                                ...
                                <div class="space-y-1">
                                    ...
                                    <div class="w-full bg-[#6E5003]/10 h-2 rounded-full overflow-hidden">
            ...
            <div class="space-y-8">
                ...
                <div class="bg-white/85 backdrop-blur-md p-8 rounded-3xl shadow-sm">
                    <h3 class="text-lg font-black text-[#604B10] flex items-center gap-2 mb-6 pb-4">
                        <x-heroicon-s-exclamation-triangle class="w-5 h-5 text-[#876A1A]"/>
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="space-y-1">
                                <div class="flex justify-between text-xs font-bold text-[#6E5003]">
                                    <span class="flex items-center gap-1.5">
                                        <span class="w-2.5 h-2.5 rounded-full bg-[#FDCB40]"></span>
                                        Resolved
                                    </span>
                                    <span>{{ $reportedResolved }} ({{ $resolvedPercent }}%)</span>
                                </div>
                                <div class="w-full bg-[#6E5003]/10 h-2 rounded-full overflow-hidden">
                                    <div class="h-full bg-[#FDCB40] rounded-full" style="width: {{ $resolvedPercent }}%"></div>
                                </div>
                            </div>
                            <div class="space-y-1">
                                <div class="flex justify-between text-xs font-bold text-[#6E5003]">
                                    <span class="flex items-center gap-1.5">
                                        <span class="w-2.5 h-2.5 rounded-full bg-[#604B10]"></span>
                                        Unresolved / Open
                                    </span>
                                    <span>{{ $openImpediments }} ({{ $openPercent }}%)</span>
                                </div>
                                <div class="w-full bg-[#6E5003]/10 h-2 rounded-full overflow-hidden">
                                    <div class="h-full bg-[#604B10] rounded-full" style="width: {{ $openPercent }}%"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white/85 backdrop-blur-md p-8 rounded-3xl shadow-sm">
                    <h3 class="text-lg font-black text-[#604B10] flex items-center gap-2 mb-6 pb-4">
                        <x-heroicon-s-star class="w-5 h-5 text-[#876A1A]"/>
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            @php
                                $dimensions = [
                                    'collaboration' => ['label' => 'Collaboration & Teamwork', 'color' => 'bg-[#604B10]'],
                                    'delivery' => ['label' => 'Quality of Delivery', 'color' => 'bg-[#876A1A]'],
                                    'communication' => ['label' => 'Communication & Presence', 'color' => 'bg-[#FDCB40]'],
                                ];
                            @endphp
        ...
        <div class="pt-6 flex justify-center pb-12">
            <form method="POST" action="{{ route('logout') }}" class="w-full max-w-sm">
                @csrf
                <button type="submit" class="w-full py-4 rounded-full bg-[#604B10] hover:bg-[#604B10]/95 text-white font-extrabold text-center shadow-sm transition duration-150 cursor-pointer outline-none border-none flex items-center justify-center gap-2 text-base">
