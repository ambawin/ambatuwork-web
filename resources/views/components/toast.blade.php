...
class="fixed top-20 right-6 z-[9999] flex flex-col gap-3 w-full max-w-sm pointer-events-none">
    ...
    <template x-for="toast in toasts" :key="toast.id">
        <div x-show="true"
             ...
             class="pointer-events-auto flex items-start gap-3.5 p-4 rounded-2xl border-2 backdrop-blur-md shadow-lg transition-all duration-300"
             :class="{
             ...
             <div class="shrink-0 mt-0.5">
                 ...
                 <template x-if="toast.type === 'success'">
                     <div class="bg-[#FDCB40]/25 p-1 rounded-lg">
                         <svg class="w-4 h-4 text-[#977926]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="3">
                 ...
                 <template x-if="toast.type === 'danger' || toast.type === 'error'">
                     <div class="bg-rose-100 p-1 rounded-lg">
                         <svg class="w-4 h-4 text-rose-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="3">
